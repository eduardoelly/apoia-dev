    ...
    return (
      <div className="flex items-center justify-between flex-1 p-2 text-gray-100">
        ...
        <Link
          href={`${process.env.NEXT_PUBLIC_HOST_URL}/creator/${username}`}
          target="_blank"
          className="px-4 py-1 bg-blue-500 rounded-md hover:bg-blue-600 hidden md:block"
        >
    ...
    <div className="w-full">
      <div className="flex items-center flex-1 p-2 text-gray-100">
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-blue-500 h-9 hover:bg-blue-600 cursor-pointer text-white w-full md:w-fit"
          >
            Salvar
          </Button>
        </form>
